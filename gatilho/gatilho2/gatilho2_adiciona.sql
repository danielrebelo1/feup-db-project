...
begin
    ...
    when(select idEquipaVisitada from jogo where jogo.idJornada = new.idJornada and (idEquipaVisitada = new.idEquipaVisitante or idEquipaVisitada = new.idEquipaVisitada))
